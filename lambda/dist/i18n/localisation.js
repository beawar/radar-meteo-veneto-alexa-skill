...
exports.languageStrings = {
    it: {
        translation: {
            ...
            REPROMPT_MSG: "Se non sai cosa fare, prova a chiedermi aiuto. Se vuoi uscire dimmi pure stop",
            GOODBYE_MSG: [
                "A presto, {{name}}! ",
                "Ciao {{name}}! ",
                "Arrivederci {{name}}! ",
            ...
            CONJUNCTION_MSG: " e ",
            HELP_MSG: "Posso recuperare le informazioni del meteo dal sito ARPAV: chiedimi di mostrarti il radar o di leggere il bollettino meteo. Come posso esserti utile?",
