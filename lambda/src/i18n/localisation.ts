export const languageStrings = {
  it: {
    translation: {
      ...
      WELCOME_MSG:
        "Benvenuto in ArpaV Radar Veneto. Chiedimi di mostrarti il radar per visualizzare le immagini radar o di leggere il bollettino meteo",
      WELCOME_BACK_MSG: "Ciao di nuovo, {{name}}! ",
      REPROMPT_MSG:
        "Se non sai cosa fare, prova a chiedermi aiuto. Se vuoi uscire dimmi pure stop",
      GOODBYE_MSG: [
        "A presto, {{name}}! ",
        "Ciao {{name}}! ",
        "Arrivederci {{name}}! ",
      ...
      UNSUPPORTED_DEVICE_MSG:
        "Questa funzionalità non è disponibile su questo dispositivo. ",
      CANCEL_MSG: "Ok, annullato. ",
      API_ERROR_MSG:
        "Sto avendo qualche intoppo contattando l'API esterna. Riprova più tardi. ",
      CONJUNCTION_MSG: " e ",
      HELP_MSG:
      ...
      REPORT_HINT: "mostrami il radar",
      NOTHING_TO_REPEAT: "Scusa, non ho nulla da ripetere.",
    },
  },
};
